...
<section>
                ...
                <div>
                    {keywords.map((keyword, index) => (
                        <button
                         ...
                         className="block mb-2 px-4 pt-2 w-full text-left border rounded hover:bg-gray-200"
                        >
                            {keyword.toUpperCase()}
                        </button>
                    ))}
            ...
            <button
             ...
             className="w-full mb-[4rem] py-2 bg-black text-white rounded mt-5">Reset Filter</button>
